...
const signUpForm = () => {
    ...
    return (
        <div className='md:w-[30%] h-screen w-full flex justify-center gap-8 flex-col items-center'>
            ...
            <h1 className='text-3xl mb-0 font-extrabold'>Start your journey</h1>
            ...
            <div className='flex w-5/6 justify-between items-center'>
                <select onChange={(e) => onchange(e)} className='w-[40%] rounded-2xl px-4 h-14 bg-[#542155]' name="countryCode" id="">
                ...
                <input onChange={(e) => onchange(e)} name='phoneNumber' type='phone' placeholder='Phone' className='rounded-2xl px-4 w-[55%] h-14 bg-[#542155]' />
            </div>
            <button onClick={(e) => onSubmit(e)} className='bg-[#BBBBBB] font-bold w-5/6 h-14 rounded-2xl'>Confirm</button>
