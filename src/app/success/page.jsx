...
function success() {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-screen'>
      ...
      <div className="w-full flex md:px-0 px-8 justify-center gap-6 items-center flex-col h-3/6">
        <h1 className="text-3xl text-center font-bold">Your trip is confirmed!</h1>
